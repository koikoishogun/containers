      ...
      <div class="container products">
            ...
            <div class="col-md-4">
                <div class="product-box">
                  <img class="img-responsive" src = "{{ URL::asset('/images/dry-containers.jpg')}}" alt = "First slide">
                  ...
                  <button class="btn btn-danger orderbutton" type="button" data-toggle="modal" data-target="#myModal"><b>Order Now</b></button>
                </div>


                <div class="product-box">
                  <img class="img-responsive" src = "{{ URL::asset('/images/roadshow.jpg')}}" alt = "First slide">
                  <p class="product-text" align="left">Spacious and quick to set up. It has a fantastic balance of usable space. From agile, quick response exhibition trailers to show-stopping mobile event spaces, we have the right technology to meet any roadshow challenge</p>
                  <p class="price-text" align="left"><span class="gray">20ft at Ksh. 180,000/-</span><b> | </b><span class="gray">40ft at Ksh. 280,000/-</span></p>
            ...
            <div class="col-md-4">
                <div class="product-box">
                  <img class="img-responsive" src = "{{ URL::asset('/images/reefers.jpg')}}" alt = "First slide">
                ...
                <div class="product-box">
                  <img class="img-responsive" src = "{{ URL::asset('/images/cyber.jpg')}}" alt = "First slide">
            ...
            <div class="col-md-4">
                <div class="product-box">
                  <img class="img-responsive" src = "{{ URL::asset('/images/stalls.jpg')}}" alt = "First slide">
                ...
                <div class="product-box">
                  <img class="img-responsive" src = "{{ URL::asset('/images/homes.jpg')}}" alt = "First slide">
